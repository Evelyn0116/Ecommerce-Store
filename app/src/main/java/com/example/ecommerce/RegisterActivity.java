        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (!(snapshot.child("Users").child(phone).exists())) {
                    ...
                    //hashMap store one user separate info, use phone as key to store in Firebase database
                    ...
                    loadingBar.dismiss();
                    Toast.makeText(RegisterActivity.this, "Please try with another email", Toast.LENGTH_SHORT).show();
//
